...
namespace CapaNegocio
{
    public class CN_Producto
    {
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            else if (string.IsNullOrEmpty(obj.Silueta) || string.IsNullOrWhiteSpace(obj.Silueta))
            {
                Mensaje = "La Silueta del Producto no puede ser vacio";
            }
        ...
        {
            return objCapaDato.TopVendidos();
        }

        public List<MasRecaudado> TopRecaudaciones()
        {
            return objCapaDato.TopRecaudaciones();
        }
